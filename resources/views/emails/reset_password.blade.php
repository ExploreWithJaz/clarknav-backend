...
<body>
    <div class="container">
        <div class="header">
            <img src="https://i.postimg.cc/BQGfDMqx/Email-header.png" alt="ClarkNav Logo" class="logo2">
        </div>
        ...
        <div class="content">
            ...
            <p>If you did not request a password reset, please ignore this email or contact support if you have
                concerns.</p>
            <p>If the button above doesn't work, you can copy and paste the following token into the password reset
                form:</p>
            <div class="token-container">
                <div class="token">{{ $token }}</div>
            </div>
            <p class="note">For security reasons, this reset link will expire after 60 minutes.</p>
        </div>
        <div class="footer">
            <p>&copy; 2025 ClarkNav. All rights reserved.</p>
            <div class="contact-info">
                <p>Need help? Contact our support team at <span class="highlight">support@clarknav.com</span></p>
            </div>
        </div>
    </div>
</body>
